...
ZONE_FILES = {
    "50Hertz":    D / "somrad/50Hertz_01_01_2021-06_13_2026.csv",
    "Amprion":    D / "somrad/Ampiron_01_01_2021-06_13_2026.csv",
    "TenneT":     D / "somrad/TenneT_01_01_2021-06_13_2026.csv",
    "TransnetBW": D / "somrad/TransnetBW_01_01_2021-06_13_2026.csv",
}
...
train.to_parquet(D / "somrad.parquet", index=False)
holdout.to_parquet(D / "somrad_forecast_holdout.parquet", index=False)
